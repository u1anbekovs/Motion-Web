                        ...
                        <div style={{
                            ...
                            <div className="OnOf--ofline__first--three">
                                ...
                                <div id="OnlineOfline">
                                    <div className="container">
                                        <div className="OnOf">
                                            <button style={{transform: "3s"}}
                                                    onClick={() => SetChoose(!choose)}>Офлайн
                                            </button>
                                            <button onClick={() => SetChoose2(!choose2)}>Онлайн</button>
                                            ...
                                            <div className="OnOf--ofline">
                                                <div style={{
                                                    ...
                                                    <div className="OnOf--ofline__first--three">
                                                        <h1>Офлайн</h1>
                                                        <li>В одной группе обучается всего 10-12-14 студентов
                                                            стандартной формы.
                                                        </li>
                                                        <li>Занятия будут проходить на кыргызском языке.</li>
                                                        <li>В Академии есть возможность практиковать внеклассное
                                                            обучение в период с 09 до 22
                                                            (OPEN SPACE).
                                                        </li>
                                        ...
                                        <div style={{
                                            ...
                                            <div className="OnOf--ofline__first--three">
                                                <h1>Онлайн</h1>
                                                <li>В одной группе обучается всего 10-12-14 студентов стандартной
                                                    формы.
                                                </li>
                                                <li>Занятия будут проходить на кыргызском языке.</li>
                                                <li>Телеграм, ZOOM
                                                ...
                                                <li>Быстрая и оперативная обратная связь от менторов</li>
                                                <div onClick={() => SetChoose(!choose)}
                                                     style={{display: choose ? "block" : "none"}}
                                                     className="OnOf--window"></div>
                                                <div style={{display: choose2 ? "block" : "none"}}
                                                     className="OnOf--window2"></div>
                                        ...
                                        <div onClick={() => SetChoose(!choose)}
                                             style={{display: choose ? "block" : "none"}}
                                             className="OnOf--window"></div>
                                        <div onClick={() => SetChoose2(!choose2)}
                                             style={{display: choose2 ? "block" : "none"}}
                                             className="OnOf--window2"></div>
